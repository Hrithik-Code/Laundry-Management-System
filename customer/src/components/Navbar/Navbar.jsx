  ...
  return (
    ...
    >
      <Container className="navbar-container">
        <Navbar.Brand to="/">
          <ion-icon name="clothes"></ion-icon>
          ...
          <Nav className="justify-content-end flex-grow-1 pe-3">
            ...
            <Nav.Item>
              <Link
                ...
                onClick={() => setExpand(false)}
              >
                <span className="nav-link-label">Book Service</span>
              </Link>
            </Nav.Item>
            ...
            {/* <Nav.Item>
              <Link
                ...
                onClick={() => setExpand(false)}
              >
                <span className="nav-link-label">Bag</span>
              </Link>
            </Nav.Item> */}
            {loggedIn ? (
              <>
            ...
            {loggedIn && (
              <Nav.Item>
                <span className="nav-link-label">Hy, {user?.name}</span>
              </Nav.Item>
            )}
