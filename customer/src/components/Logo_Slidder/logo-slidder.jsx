...
import p3 from "../../Images/dry_cleaning_11zon.webp";
import p4 from "../../Images/steam-iron.png";
import p5 from "../../Images/laundry_cleaning_11zon.webp";
import p6 from "../../Images/premium_laundry_cleaning_11zon.webp";
import "./logo.css";
    ...
    <Carousel slide={false}>
      {SliderData.map((item) => (
        <Carousel.Item key={item.id}>
          <img className="d-block" src={item.cover} alt={item.title} />
          <Carousel.Caption>
